...
public class TestController {
    ...
    @GetMapping(path = "/member/test5", headers = "test6") //요청헤더중에서 test6이 포함된 경우
    public String test6() {
        System.out.println("test6()");
        return "member/test";
    }

    @GetMapping(path = "/member/test5", headers = "test7") //요청헤더중에서 test7이 포함된 경우
    public String test7() {
        System.out.println("test7()");
        return "member/test";
    }

    @GetMapping(path = "/member/test6", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
    public String test8() {
